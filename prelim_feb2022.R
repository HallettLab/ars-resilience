...
functionalcover_pasture <- functionalcover %>%
  select(Pasture,FireHistory,Region,fullwater,Elevation,Slope,CattleDung,FuncGroup,Crested,abundance,Sand,Silt,Clay,C,N,ppt,tmean,elev_ned,totaldung) %>% # check that ppt,tmean,elev_ned,totaldung are added first
